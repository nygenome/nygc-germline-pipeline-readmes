...
3. IF APPLICABLE: Project-level Repeat Locus Summary Table  ({Repeat_locus}.summary_table.txt): Project-level summary files, 1 for each assessed locus. The columns in this file are:
